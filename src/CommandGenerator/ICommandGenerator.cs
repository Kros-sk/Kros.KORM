...
namespace Kros.KORM.CommandGenerator
{
    ...
    public interface ICommandGenerator<T>
    {
        ...
        /// <param name="ignoreValueGenerators">Inidicates whether to ignore value generators.</param>
        /// <exception cref="System.ArgumentNullException">Either <paramref name="command" /> or <paramref name="item" />
        /// is <see langword="null"/>.</exception>
        void FillCommand(DbCommand command, T item, ValueGenerated valueGenerated, bool ignoreValueGenerators = false);
